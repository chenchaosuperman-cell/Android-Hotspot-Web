...
unset MAC_MODE ALLOWED_MACS PROXY_SCOPE PROXY_SELF HIDDEN KEEPALIVE IDLE_SHUTDOWN SCHED_ENABLE CHANNEL MAX_CLIENTS LOWBATT_ENABLE LOWBATT_THRESHOLD DATA_PLAN_MB DATA_PLAN_DAY DATA_LIMIT_ACTION NOTIFY_LIMIT SMS_FWD PROXY_ENABLE BAND PORT AUTOSTART SECURITY
